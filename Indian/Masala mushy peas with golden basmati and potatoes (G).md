# Masala mushy peas with golden basmati and potatoes (Guardian)
...
Add the coconut cream (reserving the ¼ cup for garnish) and bring to the boil, then add the stock, reduce the heat to medium and simmer for five minutes.

Add the drained frozen peas and bring back to the boil, then reduce the heat to medium and simmer for four minutes. Stir through the spinach leaves and cook for one minute or until wilted. Remove saucepan from the heat and allow to cool slightly.
...
Return to the peas in the saucepan.

With a stick blender, carefully blend the mixture to achieve a consistent, but still chunky, texture (be careful when blending – the mixture is hot and may splutter). Season to taste.
