...
Grind the dry spices using a spice grinder and then add the tamarind paste, mint leaves and cilantro leaves. Using 3-4 tbsp of water, make a fine paste. Strain the paste twice so you have a clear concentrated paste. *(I used a regular sieve for the first straining and a finely meshed one for the second)*

Transfer this to a pot or jug.
